...
# Bot information
SESSION = environ.get('SESSION', 'RN Movies Search Bot')
API_ID = int(environ.get('API_ID', '26287604'))
API_HASH = environ.get('API_HASH', 'e4d64d7dcf8a145e58de0b7b66f7eab6')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5601988284').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003085020003'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002996354715').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://chinnu132004_db_user:<7yJZpi1rgqG7EV0u>@cluster0.ipxxzsl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
